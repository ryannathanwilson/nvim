return {
  {
    ...
    config = function()
      require("mason").setup({
        ensure_installed = { "stylua", "prettier", "js-debug-adapter" },
  ...
  },
  {
    ...
    config = function()
      require("mason-lspconfig").setup({
        ensure_installed = { "lua_ls", "ts_ls", "cssls", "eslint" },
      })
    end,
  },
  {
      ...
      local lsp_formatting = function(bufnr)
        vim.lsp.buf.format({
          filter = function(client)
            local shouldFormat = not found_in_table(client.name, lsp_no_auto_format_list)
